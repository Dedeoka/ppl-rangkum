...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link active" aria-current="page" href="{{ route('data-plsql') }}">Data Perhitungan
                            PlSql</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="vh-100 text-center d-flex p-5 mt-5">
        ...
        <div class="mid-content bg-white">
            <div class="text-center border border-secondary">
                <h2 class="p-3">Data Perhitungan Akar Kuadrat Dengan PlSql</h2>
    ...
    <script>
        function fetchData() {
            axios.get('/api/akar-kuadrat-plsql')
